...
function ForgotPasswordPageInner() {
  ...
  const sentQuery = String(searchParams.get("sent") || "").toLowerCase();
  const sentFromQuery = sentQuery === "1" || sentQuery === "true" || sentQuery === "yes";
  ...
  const [successMsg, setSuccessMsg] = useState<string | null>(
    sentFromQuery ? "Wiederherstellungslink gesendet. Bitte prüfe dein Postfach." : null,
  );
        ...
        <Card className="border-0 shadow-2xl bg-white/90 backdrop-blur-sm">
          <CardHeader className="text-center pb-4">
            ...
            <p className="text-gray-600 text-sm mt-1">
              Wir senden dir einen Supabase-Wiederherstellungslink per E-Mail.
            </p>
          </CardHeader>
